<template>
  <div
    class="bg-gradient-to-r from-cyan-500 to-blue-500 w-full p-2 rounded-md flex flex-col"
  >
    ...
    <div class="flex justify-between text-white">
      <div class="text-md text-gray-200 font-thin">
        {{ laybuy_item.duration }}months
      </div>
